...
# dataset path
# data_root =  "/data/local/nuplan/dataset/" # for h800 #'/home/taoran.lu/E2E/VAD/data/nuplan/'
data_root = "/data/local/nuplan/dataset" #'/home/taoran.lu/E2E/VAD/data/nuplan/'
...
ann_file_map = '/data/local/nuplan/zsy.json'
