...
# dataset path
nuplan_data_root = '/home/taoran.lu/E2E/VAD/data/nuplan/'
# nuplan_data_root = '/home/shaoze.yang/code/Bench2DriveZoo/data/nuscenes/'
...
# meta data paths:
ann_file_train = "/home/shaoze.yang/data/nuplan_to_vad/output/trainval.pkl"
# ann_file_train = "/home/shaoze.yang/data/nuplan_to_vad/train_mini.pkl"
# ann_file_train = "/home/shaoze.yang/code/Bench2DriveZoo/data/train.db"
# ann_file_train = "/home/taoran.lu/E2E/VAD/data/nuplan/2021.10.06.17.43.07_veh-28_00508_00877.pkl"
...
col_class = ['vehicle', 'pedestrian'] # collision classes, result in loss term
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        loss_plan_col=dict(type='PlanCollisionLoss', loss_weight=1.0, class_names=class_names, col_class=col_class),
...
data_root = '/home/shaoze.yang/code/Bench2DriveZoo/data/nuscenes/'
...
data = dict(
    ...
    train=dict(
        ...
        ann_file= ann_file_train, # nuplan_data_root + '2021.10.06.17.43.07_veh-28_00508_00877.pkl', #'vad_nuscenes_infos_temporal_train.pkl',
...
checkpoint_config = dict(interval=2000, by_epoch=False, max_keep_ckpts=total_epochs)

custom_hooks = [dict(type='CustomSetEpochInfoHook')]

load_from = "/home/shaoze.yang/code/Bench2DriveZoo/work_dirs/VAD_base_e2e_trainval_h800_frameidx/epoch_2.pth"