...
class BEVVisualizer:
    ...
    def visualize_bev(self, frame, ax, alpha=1.0):
        self._plot_ego_vehicle(frame, ax, alpha)
...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str, default='/data/nuplan/dataset/', help='Root directory of the dataset')
    parser.add_argument('--ann_data_path', type=str, default='vis_tools/demo/gt_sampled_300.pkl', help='Path to annotation data')
    parser.add_argument('--pred_pickle_path', type=str, default='vis_tools/demo/pred_sampled_300.pkl', help='Path to prediction data')
    parser.add_argument('--output_type', type=str, choices=['image', 'gif'], default='gif', help='Output type: image or gif')
    parser.add_argument('--output_dir', type=str, default='vis_tools/demo/vis_out', help='Output directory for visualizations')
