...
point_cloud_range = [-60.0, -40.0, -2.0, 60.0, 40.0, 2.0] # nuplan
...
evaluation = dict(interval=2000, pipeline=val_pipeline, metric='bbox', map_metric='chamfer')
...
log_config = dict(
    ...
    hooks=[
        ...
        dict(type='WandbLoggerHook',
             init_kwargs={
                 'project': 'lwad',
                 'entity': 'lightwheel-ccy',
                 'name': 'vad_base_e2e_dev'
             })
    ])
