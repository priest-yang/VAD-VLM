...
class SqliteDictWrapper:
    def __init__(self, sqlite_db_path):
        ...
        self.cursor.execute("SELECT seq FROM sqlite_sequence WHERE name = 'infos'")  # use autoincrement seq to get length, could be faster, but not guaranteed if rows are deleted
