...
class VADV2Head(DETRHead):
    ...
    def forward(self,
        ...
        pred_dis = v_xy * Dt + 1 / 2 * a_xy * Dt**2 # future displacement assuming constant acceleration
        kinodynamic_mask = (torch.norm(self.plan_anchors[:,-1,:], dim=-1) - pred_dis).abs() < 500 # 500m threshold
